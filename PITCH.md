...
Road damage is a safety, cost, and equity issue. Inspections are often manual and periodic, so hazards can remain unaddressed until they become expensive failures.
...
This means agencies can move from reactive patching to risk-aware planning.

## 3) Why It Is Different

Most projects stop at detection. We go further:
...
1. Upload road video (and optional GPS CSV).
2. Show live annotated detections.
...
- Faster and more scalable inspections
- Better maintenance ROI
- Safer roads for drivers, buses, and freight
- Transparent prioritization for public accountability
